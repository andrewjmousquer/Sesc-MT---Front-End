        ...
        <div className="bottom-footer">
          <div className="row">
            ...
            <div className=" pt-3 col-md-3">
              <div className="icons">
                <FaLinkedin href="#" font-size="25" title="Linkedin" />
                <FaTwitterSquare href="#" font-size="25" title="Twitter" />
                <FaFacebookSquare href="#" font-size="25" title="Facebook" />
                <FaInstagramSquare href="#" font-size="25" title="Instagran" />
              </div>
            </div>
          </div>
        </div>
